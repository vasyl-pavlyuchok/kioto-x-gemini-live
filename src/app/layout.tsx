...
export const metadata: Metadata = {
  ...
  description: 'Explora Kioto con Gemini Live: lee menús, escucha anuncios de trenes e identifica lugares icónicos en una experiencia interactiva del RetoIA.',
};
